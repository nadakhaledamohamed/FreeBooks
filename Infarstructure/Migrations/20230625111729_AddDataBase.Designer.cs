...
namespace Infarstructure.Migrations
{
    ...
    [Migration("20230625111729_AddDataBase")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Infarstructure.ViewModel.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Domain.Entity.LogSubCategory", b =>
                {
                    b.HasOne("Domain.Entity.Category", "SubCategory")
                        .WithMany()
                        .HasForeignKey("SubCategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Infarstructure.ViewModel.ApplicationUser", null)
                        .WithMany()
